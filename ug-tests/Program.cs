...
namespace ug_tests
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var subscription = UgApi.Iugu.Shortcut.Subscription(
            //                           "Teste",
            //                           "teste@teste.com",
            //                           "683.863.474-06",
            //                           /*Request.IsLocal ? 1 :*/ 30,
            //                           "Teste de inscrição",
            //                           1, payableWith: "all", planIdentifier: "Inscrição").Result;
            ...
            //var subscriptions = Ug.UgApi.Iugu.Subscription.List(new Ug.Model.Request.SubscriptionsRequest()
            //{
            //    start = 0,
            //    limit = 10
            //}).Result;
            ...
            //foreach (var sub in subscriptions.items.Take(1))
            //{
            //    var subscription = Ug.UgApi.Iugu.Subscription.Get(sub.id).Result;
            //    var retorno = Ug.UgApi.Iugu.Subscription.Change(subscription.id, new
            //    {
            //        expires_at = "2015-12-29"
            //    }).Result;

            //    //var invoice = subscription.recent_invoices.Any(c => c.id == "2690CCE4508547E7B2BAE81322E51C1B");
            ...
            //var startDate = baseDate.AddMonths(-6).ToString("yyyy-MM-dd");
            //var endDate = baseDate.ToString("yyyy-MM-dd");

            //var entities = Ug.UgApi.Iugu.Invoice.List(new Ug.Model.Request.InvoicesRequest()
            //{
            //    start = 0,
            //    limit = 10,
            //    query = "paid",
            ...
            //var invoice = Ug.UgApi.Iugu.Invoice.Get(entities.items[0].id).Result;
